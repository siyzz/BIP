...
{
    public partial class MetroMessageBoxControl : MetroForm
    {
        ...
        private Color _defaultColor = Color.FromArgb(171, 206, 228);//Color.FromArgb(57, 179, 215);

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private Color _errorColor = Color.FromArgb(171, 206, 228);//Color.FromArgb(210, 50, 45);

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private Color _warningColor = Color.FromArgb(171, 206, 228);//Color.FromArgb(237, 156, 40);

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private Color _success = Color.FromArgb(171, 206, 228);//Color.FromArgb(0, 170, 173);

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private Color _question = Color.FromArgb(171, 206, 228);//Color.FromArgb(71, 164, 71);
